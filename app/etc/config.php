...
return [
    'modules' => [
        ...
        'Magento_Worldpay' => 1,
        'Alhayat_BannerSlider' => 1,
        'Alhayat_CustomLogFile' => 0,
        'Alhayat_CustomerAccount' => 0,
        'Alhayat_CustomerCondition' => 0,
        'Alhayat_CustomerRedirecting' => 0,
        'Alhayat_Menu' => 0,
        'Alhayat_ServiceContract' => 0,
        'Alhayat_TextLink' => 0,
        'Alhayat_TransactionalEmail' => 0,
        'Alhayat_UrlRewrite' => 0,
        'Amazon_Core' => 1,
        'Amazon_Login' => 1,
        'Amazon_Payment' => 1,
