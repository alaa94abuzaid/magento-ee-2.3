...
namespace Alhayat\BannerSlider\Ui\Component\Listing\Column;
...
class BannerActions extends Column
{
     ...
     * Url path
     */
    const URL_PATH_EDIT = 'alhayat_banners_slider/banner/edit';
    const URL_PATH_DELETE = 'alhayat_banners_slider/banner/delete';
