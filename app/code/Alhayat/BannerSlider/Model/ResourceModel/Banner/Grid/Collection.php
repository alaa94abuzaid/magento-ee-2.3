...
namespace Alhayat\BannerSlider\Model\ResourceModel\Banner\Grid;

use Magento\Framework\Api\ExtensibleDataInterface;
use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Api\Search\AggregationInterface;
use Alhayat\BannerSlider\Model\ResourceModel\Banner\Collection as BannerCollection;
...
class Collection extends BannerCollection implements SearchResultInterface
{
    ...
    protected function _renderFiltersBefore()
    {
        $this->getSelect()->joinLeft(
            ['group' => $this->getTable('alhayat_banners_slider_group')],
